...
def search(
	...
	career_level_id: Optional[int] = Query(None, description="커리어 레벨 ID", alias="careerLevelId"),
	experience_range_id: Optional[int] = Query(None, description="경력 구간 ID", alias="experienceRangeId"),
