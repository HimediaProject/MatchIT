    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-200 p-8">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-10">
          ...
          <div className="mb-2">MatchIT</div>
          <p className="text-sm text-gray-600">기술 스택 기반 채용·교육 매칭 플랫폼</p>
        </div>

        {/* Login Box */}
        <div className="border-2 border-gray-900 bg-white p-12">
          <div className="text-center mb-8">
            <div className="mb-2">소셜 계정으로 로그인</div>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 border border-gray-900 bg-gray-50 hover:bg-gray-100 flex items-center gap-4 px-6"
            >
            ...
            >
              ...
              <span className="flex-1 text-left">GitHub 계정으로 계속</span>
            </button>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-600 mb-2">로그인 시 아래 약관에 동의하게 됩니다</p>
